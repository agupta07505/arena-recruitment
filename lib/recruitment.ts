...
export const positions: Position[] = [
  ...
  {
    slug: "womens-participation-coordinator",
    title: "Women's Participation Coordinator",
    capacity: 1,
    eligibleYears: [3, 4],
    division: "operations",
    summary: "Create welcoming pathways for women to participate, compete, volunteer, and lead across A.R.E.N.A events.",
    signal: "Grow participation",
  },
  {
